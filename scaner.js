...
const IGNORE_FILE = ['__build', 'node_modules', 'dist', '.git', 'build_scripts', 'Moxie.cdn.swf', '.DS_Store', 'Gruntfile.js', '.eslintrc.js', 'config.js', 'utils.js', 'components.js', 'routes.js', 'utils'];
const IGNORE_FOLDER = ['wireless', 'res']; // 要过滤某个文件夹，但不过滤其他文件夹下与其同名的文件放在这里
let fileContent = [];
let allFilesList = [];
let usedFiles = [];
let wasteRes = [];
